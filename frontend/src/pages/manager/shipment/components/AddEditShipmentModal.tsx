                        ...
                        {vehicles.map((v) => (
                            <Select.Option key={v.id} value={v.id} label={v.licensePlate}>
                                <div className="shipment-add-edit-select-contain">
                                    ...
                                    <span
                                        className="shipment-add-edit-select-extra"><strong>Sức chứa:</strong> {v.capacity} Kg</span>
                                    <span
                                        className="shipment-add-edit-select-extra"><strong>Loại:</strong> {translateVehicleType(v.type)}</span>
                                </div>
                            </Select.Option>
                        ))}
                    </Select>
                        ...
                        {selectedOffice && (
                            <div className="shipment-add-edit-selected-office">
                                <div className="shipment-add-edit-select-contain">
                                    ...
                                    <span
                                        className="shipment-add-edit-select-extra">Địa chỉ: {selectedOffice.detail}</span>
