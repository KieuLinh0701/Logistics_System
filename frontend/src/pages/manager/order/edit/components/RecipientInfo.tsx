                        ...
                        <Row gutter={16} >
                            ...
                            <Col span={12}>
                                <AddressForm
                                    form={form}
                                    prefix="recipient"
                                    disableCity={!canManagerEditOrderField('recipientCityCode', status, creator)}
                                    disableWard={!canManagerEditOrderField('recipientWardCode', status, creator)}
                                    disableDetailAddress={!canManagerEditOrderField('recipientDetailAddress', status, creator)}
                                />
                            </Col>
                        </Row>
                    </div>
