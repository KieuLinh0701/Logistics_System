...
import ShipmentHistoryToolbar from './components/ShipmentHistoryToolbar';
import ShipmentHistoryTable from './components/ShipmentHistoryTable';
import ShipmentHistoryActions from './components/ShipmentHistoryActions';

const ShipperShipmentHistoryPage: React.FC = () => {
    ...
    const handleFilterChange = (filter: string, value: string) => {
        switch (filter) {
            ...
            case 'sort': setFilterSort(value); break;
        ...
        <div className="list-page-layout">
            <div className="list-page-content">
                ...
                <Row className="list-page-header" align="middle">
                    ...
                    <Col>
                        <ShipmentHistoryActions onExport={handleExport} total={total} />
                    </Col>
                </Row>
...
export default ShipperShipmentHistoryPage;
