...
const ShipperShipmentOrdersPage: React.FC = () => {
    ...
    const handleExport = async () => {
        try {
            const result = await shipmentApi.exportShipperOrdersByShipmentId(Number(shipmentId), {
                page: page,
                limit,
                search: searchText,
            });
        ...
        },
        {
            ...
            render: (_, record) => (
                <div>
                    ...
                    <div><span className="text-muted">({translateOrderPaymentStatus(record.paymentStatus)})</span></div>
                </div>
            ),
        },
        {
        ...
        },
        {
            ...
            render: (_, record) => (
                <div>
                    ...
                    <span className="custom-table-content-limit">{record.senderFullAddress || "Chưa có địa chỉ"}</span>
                </div>
            ),
        },
        {
            ...
            render: (_, record) => (
                <div>
                    ...
                    <span className="custom-table-content-limit">{record.recipientFullAddress || "Chưa có địa chỉ"}</span>
                </div>
            ),
        },
    ];
...
export default ShipperShipmentOrdersPage;
