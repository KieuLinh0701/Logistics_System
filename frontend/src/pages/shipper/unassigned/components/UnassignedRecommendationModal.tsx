...
const UnassignedRecommendationModal: React.FC<UnassignedRecommendationModalProps> = ({
  ...
  // Đơn hoàn (SENDER_RETURN) → điểm đến là shop/người gửi.
  const destinationType =
    (order as any).destinationType === "SENDER_RETURN" ? "SENDER_RETURN" : "RECIPIENT";
  const destinationLabel =
    destinationType === "SENDER_RETURN" ? "shop/người gửi" : "người nhận";
  const distanceLabel =
