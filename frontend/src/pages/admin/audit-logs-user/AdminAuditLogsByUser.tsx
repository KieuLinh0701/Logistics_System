...
const AdminAuditLogsByUser = () => {
    ...
    const fetchLogs = async (page = currentPage) => {
        ...
        try {
            ...
            const result = await auditLogApi.listAdminAuditLogsByUserId(userId, param);
            ...
            if (result.success && result.data) {
                ...
                message.error(result.message || "Lỗi khi lấy danh sách lịch sử hoạt động của người dùng");
            }
        } catch (error: any) {
            message.error(error.message || "Lỗi khi lấy danh sách lịch sử hoạt động của người dùng");
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleExport = async () => {
        ...
        try {
            ...
            const result = await auditLogApi.exportAdminByUserId(userId, param);
...
export default AdminAuditLogsByUser;