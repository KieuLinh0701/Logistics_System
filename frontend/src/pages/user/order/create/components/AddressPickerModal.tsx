                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="create-order-card-icons">
                                {hasPermissionGroup(['GROUP_USER', 'USER_ADDRESS_EDIT']) && (
                                    <EditOutlined
                                ...
                                {hasPermissionGroup(['GROUP_USER', 'USER_ADDRESS_DELETE']) && (
                                    <DeleteOutlined
                            ...
                            {hasPermissionGroup(['GROUP_USER', 'USER_ADDRESS_SET_DEFAULT']) && (
