...
const UserSettlementBatchDetail = () => {
    ...
    useEffect(() => {
        ...
        updateURL();
    }, [pageSize, currentPage, searchText, dateRange, filterSort, filterStatus, filterPayer, filterCod, currentTab]);
                            ...
                            children:
                                <>
                                    ...
                                    {transactions.length > 0 && (
                                        <Tag className="list-page-tag">Kết quả trả về: {transactions.length} giao dịch</Tag>)}
