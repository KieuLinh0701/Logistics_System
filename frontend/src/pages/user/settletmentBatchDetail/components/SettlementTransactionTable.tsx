...
import {
    translateSettlementTransactionStatus,
    translateSettlementTransactionType
} from "../../../../utils/settlementTransactionUtils";
        ...
        },
        {
            ...
            render: (_, record) => {
                ...
                return (
                    <div>
                        <div>
                            <span className="custom-table-content-strong">Tạo: </span>
                            {createdAt ? createdAt : <span className="text-muted">N/A</span>}
                        </div>
                        <div>
                            <span className="custom-table-content-strong">Thanh toán: </span>
