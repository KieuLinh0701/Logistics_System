...
const UserAuditLogs = () => {
    ...
    const fetchLogs = async (page = currentPage) => {
        try {
            ...
            const result = await auditLogApi.listUserAuditLogs(param);
    ...
    const handleExport = async () => {
        try {
            const param: AuditLogSearchRequest = {
                ...
                action: filterAction !== "ALL" ? filterAction : undefined,
                entity: filterEntity !== "ALL" ? filterEntity : undefined,
                status: filterStatus !== "ALL" ? filterStatus : undefined, sort: filterSort,
            };
            if (dateRange) {
            ...
            const result = await auditLogApi.exportUser(param);
