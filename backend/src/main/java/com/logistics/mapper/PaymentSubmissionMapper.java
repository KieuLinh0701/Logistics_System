...
public class PaymentSubmissionMapper {
    ...
    public static AdminPaymentSubmissionListDto toAdminDto(PaymentSubmission entity) {
        if (entity == null) return null;

        AdminPaymentSubmissionListDto dto = new AdminPaymentSubmissionListDto();
        ...
        if (entity.getOrder() != null) {
            dto.setOrder(
                new AdminPaymentSubmissionListDto.Order(
                    entity.getOrder().getTrackingNumber()
                )
            );
        }
        ...
        if (entity.getCheckedBy() != null) {
            dto.setCheckedBy(
                new AdminPaymentSubmissionListDto.User(
                    entity.getCheckedBy().getLastName(),
                    entity.getCheckedBy().getFirstName(),
                    entity.getCheckedBy().getPhoneNumber()
                )
