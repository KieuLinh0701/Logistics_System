...
public enum PromotionErrorCode implements BaseErrorCode {
    ...
    PROMOTION_CODE_EXISTED(HttpStatus.BAD_REQUEST, "Mã khuyến mãi đã tồn tại"),
    PROMOTION_INVALID_DATE_RANGE(HttpStatus.BAD_REQUEST, "Ngày kết thúc phải sau ngày bắt đầu"),
    PROMOTION_CODE_REQUIRED(HttpStatus.BAD_REQUEST, "Mã khuyến mãi không được để trống"),
    ;
