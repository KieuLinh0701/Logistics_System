...
public class OrderFulfillmentService {
    ...
    public OrderFulfillmentSummaryDto getFulfillmentSummary(Long orderId) {
        ...
        // After removing partial delivery, either full delivery or full return
        // No partial states
        int deliveredItems = totalItems;
        int returnedItems = 0;
        long collectedCod = expectedCod; // Full COD when fully delivered
