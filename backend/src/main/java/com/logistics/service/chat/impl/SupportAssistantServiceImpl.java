...
import com.logistics.service.chat.SupportBotMessageService;
import com.logistics.service.chat.SupportIntentDetector;
...
public class SupportAssistantServiceImpl implements SupportAssistantService {
    ...
    private String mapOrderHistoryAction(OrderHistoryActionType action) {
        ...
        return switch (action) {
            ...
            case RETURNED -> "Đã hoàn hàng";
            case CANCELLED -> "Đã hủy";
            case ASSIGNED_TO_DELIVERY_TRIP -> "Đã phân công cho chuyến giao";
            case ORDER_LOADED_ON_VEHICLE -> "Đã quét QR xác nhận lên xe";
            case DELIVERY_STARTED -> "Bắt đầu chuyến giao";
        };
    }
