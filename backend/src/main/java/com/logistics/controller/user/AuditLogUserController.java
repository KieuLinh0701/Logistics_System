...
import com.logistics.service.user.AuditLogUserService;
...
@Tag(name = "User - Audit Logs", description = "Quản lý và theo dõi nhật ký hoạt động cửa hàng, hỗ trợ xuất báo cáo")
public class AuditLogUserController {

    private final AuditLogUserService service;

    @GetMapping
    public ResponseEntity<ApiResponse<ListResponse<UserAuditLogDto>>> list(
            @Valid AuditLogSearchRequest auditLogSearchRequest,
            HttpServletRequest request) {
        Integer userId = (Integer) request.getAttribute("currentUserId");

        ListResponse<UserAuditLogDto> result = service.list(userId, auditLogSearchRequest);
    ...
    public ResponseEntity<byte[]> export(HttpServletRequest request,
        ...
        String fileName = "UTE Logistics_Báo cáo lịch sử hoạt động của cửa hàng.xlsx";
